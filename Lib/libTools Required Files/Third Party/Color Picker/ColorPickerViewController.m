...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"Choose Color";
...
- (IBAction) chooseEmptyColor {
    UIColor* emptyColor = [UIColor clearColor];
    [delegate colorPickerViewController:self didSelectColor:emptyColor];
}
...
- (IBAction) cancelColorSelection {
    ...
    [delegate noteEditCancelButtonPressed];
    #endif
}
